"""
Django settings for promenade project.
...
SECRET_KEY = 'bjjjq^90w^*miair8jvyt2q&mv_k3@q3c-)g1cv(bmtd#0nc79'
...
WSGI_APPLICATION = 'promenade.wsgi.application'
